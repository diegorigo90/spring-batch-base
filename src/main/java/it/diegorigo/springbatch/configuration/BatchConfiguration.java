package it.diegorigo.springbatch.configuration;

import it.diegorigo.springbatch.dto.Person;
import it.diegorigo.springbatch.processor.PersonItemProcessor;
...
public class BatchConfiguration {
    ...
    @Bean
    public Job myJob(JobExecutionListener listener, Step step1) {
